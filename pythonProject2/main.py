...
window = Tk()
window.title("Snake Game Bruh")
score = 0
direction = 'down'
# label for score
label = Label(window, text="Score:{}".format(score), font=('Helvetica', 20))
label.pack()
# game window background
canvas = Canvas(window, bg=BACKGROUND_COLOR, height=Game_H, width=GAME_W)
canvas.pack()
window.update()
